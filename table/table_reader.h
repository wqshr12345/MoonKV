...
class TableReader {
 public:
  ...
  virtual Status Get(const ReadOptions& readOptions, const Slice& key,
                     ...
                     bool skip_filters = false, const ImmutableOptions& ioptions = ImmutableOptions()) = 0;

  //func: 根据offset和size获得一个value的值，存到value中。
  // 这个仅在NvmTable中有用，其他子类中返回一个Status::OK();
  virtual Status Get2(const ReadOptions& readOptions, const uint64_t& offset,
