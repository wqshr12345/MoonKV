...
const std::vector<std::pair<Tickers, std::string>> TickersNameMap = {
    ...
    {BLOCKS_NO_ESTIMATE, "rocksdb.blocks.noestimate"},
    {BLOCKS_WITH_ESTIMATE, "rocksdb.blocks.withestimate"},
    {NUM_SEARCH_KEYS, "rocksdb.num.searchkeys"},
    {NUM_SEARCH_FILES, "rocksdb.num.searchfiles"},
    {NUM_NOT_FOUND, "rocksdb.num.notfound"},
    {NUM_FOUND, "rocksdb.num.found"},
    {NUM_MERGE, "rocksdb.num.merge"},
    {NUM_SEEK_MERGE_KEY_TIMES, "rocksdb.num.seek.merge.key.times"},
    {NUM_SEEK_FULL_KEY_TIMES, "rocksdb.num.seek.full.key.times"},
    {NUM_SEEK_MERGE_KEYS_INCLUDE_RELATED_FULL_KEYS, "rocksdb.num.seek.merge.keys.include.related.full.keys"},
    {NUM_SEEK_LEVELS, "rocksdb.num.seek.levels"},
    {NUM_SEEK_TIMES, "rocksdb.num.seek.times"},
    ...
    {FLUSH_ENTRIES, "rocksdb.flush.entries"},
...
const std::vector<std::pair<Histograms, std::string>> HistogramsNameMap = {
    ...
    {CHILDREN_RANK_COMPUTE,"rocksdb.children.rank.compute"},
    {DB_WRITE, "rocksdb.db.write.micros"},
    {DB_LSM_GET,"rocksdb.db,lsm.get.micros"},
    {DB_TABLE_CACHE_GET,"rocksdb.db.table.cache.get.micros"},
    {DB_TABLE_GET,"rocksdb.db.table.get.micros"},
    {DB_FIND_TABLE_GET,"rocksdb.db.find.table.get.micros"},
    {DB_SAVE_VALUE_GET,"db.save.value.get.micros"},
    {DB_POSITION_GET,"rocksdb.db.position.get.micros"},
    {DB_ITER_NEXT_GET,"rocksdb.db.iter.next.get.micros"},
    {DB_CHILDREN_RANK_GET,"rocksdb.db.children.rank.get.micros"},
    {DB_INDEX_GET,"rocksdb.db.get.index.micros"},
    {DB_INDEX_UNES_GET, "rocksdb.db.index.unes.get.micros"},
    {DB_INDEX_UNES_PARTIAL_GET, "rocksdb.db.index.unes.partial.get.micros"},
    {DB_INDEX_ENES_NOES_GET, "rocksdb.db.index.enes.noes.get.micros"},
    {DB_INDEX_ENES_WITHES_GET, "rocksdb.db.index.enes.withes.get.micros"},
    {DB_INDEX_ENES_WITHES_PARTIAL_GET, "rocksdb.db.index.enes.withes.partial.get.micros"},
    {DB_INDEX_KEY_POS_LIST_GET, "rocksdb.db.index.key.pos.list.get.micros"},
    {DB_INDEX_KEY_POS_GET, "rocksdb.db.index.key.pos.get.micros"},
    {DB_INDEX_ADD_KEY_POS, "rocksdb.db.index.add.key.pos.micros"},
    {DB_INDEX_ADD_KEY_POS_LIST, "rocksdb.db.index.add.key.pos.list.micros"},
    {DB_INDEX_SEEK1_GET,"rocksdb.db.index.seek1.get.micros"},
    {DB_INDEX_SEEK2_GET,"rocksdb.db.index.seek2.get.micros"},
    {DB_INDEX_SEEK3_GET,"rocksdb.db.index.seek3.get.micros"},
    {DB_INDEX_SEEK4_GET,"rocksdb.db.index.seek4.get.micros"},
    {DB_INDEX_SEEK5_GET,"rocksdb.db.index.seek5.get.micros"},
    {DB_INDEX_SEEK6_GET,"rocksdb.db.index.seek6.get.micros"},
    {DB_INDEX_SEEK7_GET,"rocksdb.db.index.seek7.get.micros"},
    {DB_INDEX_SEEK8_GET,"rocksdb.db.index.seek8.get.micros"},
    {DB_INDEX_SEEK9_AND_UP_GET,"rocksdb.db.index.seek9.and.up.get.micros"},
    {DB_INDEX_LEVEL1_GET, "rocksdb.db.index.level1.get.micros"},
    {DB_INDEX_LEVEL2_GET, "rocksdb.db.index.level2.get.micros"},
    {DB_INDEX_LEVEL3_GET, "rocksdb.db.index.level3.get.micros"},
    {DB_INDEX_LEVEL4_GET, "rocksdb.db.index.level4.get.micros"},
    {DB_INDEX_LEVEL5_GET, "rocksdb.db.index.level5.get.micros"},
    {DB_INDEX_LEVEL6_GET, "rocksdb.db.index.level6.get.micros"},
    {DB_INDEX_LEVEL7_GET, "rocksdb.db.index.level7.get.micros"},
    {DB_INDEX_LEVEL8_GET, "rocksdb.db.index.level8.get.micros"},
    {DB_INDEX_LEVEL9_AND_UP_GET, "rocksdb.db.index.level9.and.up.get.micros"},
    {DB_INDEX_LEVEL1_SEEK_BLOCKS,"rocksdb.index.level1.seek.blocks"},
    {DB_INDEX_LEVEL2_SEEK_BLOCKS,"rocksdb.index.level2.seek.blocks"},
    {DB_INDEX_LEVEL3_SEEK_BLOCKS,"rocksdb.index.level3.seek.blocks"},
    {DB_INDEX_LEVEL4_SEEK_BLOCKS,"rocksdb.index.level4.seek.blocks"},
    {DB_INDEX_LEVEL5_SEEK_BLOCKS,"rocksdb.index.level5.seek.blocks"},
    {DB_INDEX_LEVEL6_SEEK_BLOCKS,"rocksdb.index.level6.seek.blocks"},
    {DB_INDEX_LEVEL7_SEEK_BLOCKS,"rocksdb.index.level7.seek.blocks"},
    {DB_INDEX_LEVEL8_SEEK_BLOCKS,"rocksdb.index.level8.seek.blocks"},
    {DB_INDEX_LEVEL9_AND_UP_SEEK_BLOCKS,"rocksdb.index.level9up.seek.blocks"},
    {DB_DATA_GET,"rocksdb.db.get.data.micros"},
    {DB_DATA_CACHE_GET,"rocksdb.db.get.data.cache.micors"},
    {DB_DATA_DISK_GET, "rocksdb.db.get.data.disk.micros"},
    {DB_DATA_REAL_DISK_GET,"rocksdb.db.get.data.real.disk.micros"},
    {DB_GET_FULL_KEY,"rocksdb.db.get.full.key.micros"},
    {DB_GET_MERGE_KEY_1,"rocksdb.db.get.merge.key.1.micros"},
    {DB_GET_MERGE_KEY_2,"rocksdb.db.get.merge.key.2.micros"},
    {DB_GET_MERGE_KEY_3,"rocksdb.db.get.merge.key.3.micros"},
    {DB_GET_MERGE_KEY_4,"rocksdb.db.get.merge.key.4.micros"},
    {DB_GET_MERGE_KEY_5_up,"rocksdb.db.get.merge.key.5.up.micros"},
    {DB_GET_FULL_KEY_NOL0,"rocksdb.db.get.full.key.nol0.micros"},
    {DB_GET_MERGE_KEY_1_NOL0,"rocksdb.db.get.merge.key.1.nol0.micros"},
    {DB_GET_MERGE_KEY_2_NOL0,"rocksdb.db.get.merge.key.2.nol0.micros"},
    {DB_GET_MERGE_KEY_3_NOL0,"rocksdb.db.get.merge.key.3.nol0.micros"},
    {DB_GET_MERGE_KEY_4_NOL0,"rocksdb.db.get.merge.key.4.nol0.micros"},
    {DB_GET_MERGE_KEY_5_up_NOL0,"rocksdb.db.get.merge.key.5.up.nol0.micros"},    
    {DB_GET_LEVEL_1,"rocksdb.db.get.level.1.micros"},
    {DB_GET_LEVEL_2,"rocksdb.db.get.level.2.micros"},
    {DB_GET_LEVEL_3,"rocksdb.db.get.level.3.micros"},
    {DB_GET_LEVEL_4,"rocksdb.db.get.level.4.micros"},
    {DB_GET_LEVEL_5_up,"rocksdb.db.get.level.5.up.micros"},
    {DB_SEEK_1_TIMES, "rocksdb.db.seek.1.times"},
    {DB_SEEK_2_TIMES, "rocksdb.db.seek.2.times"},
    {DB_SEEK_3_TIMES, "rocksdb.db.seek.3.times"},
    {DB_SEEK_4_TIMES, "rocksdb.db.seek.4.times"},
    {DB_SEEK_5_TIMES, "rocksdb.db.seek.5.times"},
    {DB_SEEK_6_TIMES, "rocksdb.db.seek.6.times"},
    {DB_SEEK_7_TIMES, "rocksdb.db.seek.7.times"},
    {DB_SEEK_8_TIMES, "rocksdb.db.seek.8.times"},
    {DB_SEEK_9_AND_UP_TIMES, "rocksdb.db.seek.9.and.up.times"},
  ...
  for (const auto& h : HistogramsNameMap) {
    ...
    int ret =
        snprintf(buffer, kTmpStrBufferSize,
                 ...
                 hData.percentile99, hData.max, hData.count, hData.sum, hData.average);
