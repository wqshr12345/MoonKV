...
Status DBImpl::GetImpl(const ReadOptions& read_options, const Slice& key,
  ...
  uint64_t elapsed = 0;
  int merge_keys = 0;  // 本次查询实际查的kTypeMerge的个数
  int merge_levels = 0; // 本次查询实际经过的level(level0如果有多个文件 也算作多个level)
  int merge_times = 0; // 本次查询实际查询的sst个数（包括在sst查到和没查到的）
  int merge_keys_nol0 = 0;
  auto* sw1 = new StopWatch(immutable_db_options_.clock, nullptr, 0, &elapsed);
  ...
  if (!done) {
    ...
    uint64_t elapsed2 = 0;
    StopWatch sw2(immutable_db_options_.clock, stats_, DB_LSM_GET, &elapsed2);
    sv->current->Get(
        ...
        get_impl_options.get_value, &merge_keys, &merge_levels, &merge_times, &merge_keys_nol0);

    switch (merge_levels) {
      case 0:
        break;
      case 1:
        stats_->reportTimeToHistogram(DB_GET_LEVEL_1, elapsed2);
        break;
      case 2:
        stats_->reportTimeToHistogram(DB_GET_LEVEL_2, elapsed2);
        break;
      case 3:
        stats_->reportTimeToHistogram(DB_GET_LEVEL_3, elapsed2);
        break;
      case 4:
        stats_->reportTimeToHistogram(DB_GET_LEVEL_4, elapsed2);
        break; 
      default:
        stats_->reportTimeToHistogram(DB_GET_LEVEL_5_up, elapsed2);
        break;
    }
  ...
  switch (merge_keys) {
    case 0:
      break;
    case 1:
      stats_->reportTimeToHistogram(DB_GET_FULL_KEY, elapsed);
      break;
    case 2:
      stats_->reportTimeToHistogram(DB_GET_MERGE_KEY_1, elapsed);
      break;
    case 3:
      stats_->reportTimeToHistogram(DB_GET_MERGE_KEY_2, elapsed);
      break;
    case 4:
      stats_->reportTimeToHistogram(DB_GET_MERGE_KEY_3, elapsed);
      break;
    case 5:
      stats_->reportTimeToHistogram(DB_GET_MERGE_KEY_4, elapsed);
      break;
    default:
      stats_->reportTimeToHistogram(DB_GET_MERGE_KEY_5_up, elapsed);
      break;
  }
  switch (merge_keys_nol0) {
    case 0:
      break;
    case 1:
      stats_->reportTimeToHistogram(DB_GET_FULL_KEY_NOL0, elapsed);
      break;
    case 2:
      stats_->reportTimeToHistogram(DB_GET_MERGE_KEY_1_NOL0, elapsed);
      break;
    case 3:
      stats_->reportTimeToHistogram(DB_GET_MERGE_KEY_2_NOL0, elapsed);
      break;
    case 4:
      stats_->reportTimeToHistogram(DB_GET_MERGE_KEY_3_NOL0, elapsed);
      break;
    case 5:
      stats_->reportTimeToHistogram(DB_GET_MERGE_KEY_4_NOL0, elapsed);
      break;
    default:
      stats_->reportTimeToHistogram(DB_GET_MERGE_KEY_5_up_NOL0, elapsed);
      break;
  }
  switch (merge_times) {
    case 0:
      break;
    case 1:
      stats_->reportTimeToHistogram(DB_SEEK_1_TIMES, elapsed);
      break;
    case 2:
      stats_->reportTimeToHistogram(DB_SEEK_2_TIMES, elapsed);
      break;
    case 3:
      stats_->reportTimeToHistogram(DB_SEEK_3_TIMES, elapsed);
      break;
    case 4:
      stats_->reportTimeToHistogram(DB_SEEK_4_TIMES, elapsed);
      break;
    case 5:
      stats_->reportTimeToHistogram(DB_SEEK_5_TIMES, elapsed);
      break;
    case 6:
      stats_->reportTimeToHistogram(DB_SEEK_6_TIMES, elapsed);
      break;
    case 7:
      stats_->reportTimeToHistogram(DB_SEEK_7_TIMES, elapsed);
      break;
    case 8:
      stats_->reportTimeToHistogram(DB_SEEK_8_TIMES, elapsed);
      break;
    default:
      stats_->reportTimeToHistogram(DB_SEEK_9_AND_UP_TIMES, elapsed);
      break;
  }
  return s;
}
