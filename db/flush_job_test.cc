...
class FlushJobTestBase : public testing::Test {
 protected:
  ...
  void SetUp() override {
    ...
    // TableOption中的block_align必须是开启的
    BlockBasedTableOptions bbto;
    bbto.block_align = true;
    cf_options_.table_factory = std::make_shared<NvmPartitionFactory>(bbto);
    cf_options_.second_table_factory = std::make_shared<NvmTableFactory>(bbto);
