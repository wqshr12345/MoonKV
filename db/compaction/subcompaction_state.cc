...
Status SubcompactionState::AddToOutput(
  ...
  return Current().AddToOutput(iter, open_file_func, close_file_func, compaction->is_gc_compaction(), compaction->is_vertical_compaction(), first_pick_guard);
}
