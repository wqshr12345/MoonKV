...
// non-ok status with specific reason.
  ...
  std::unordered_set<Compaction*>* gc_compactions_in_progress() {
    return &gc_compactions_in_progress_;
  }
...
// sanitizes "input_files" by adding necessary files.
  ...
  std::unordered_set<Compaction*> gc_compactions_in_progress_;
