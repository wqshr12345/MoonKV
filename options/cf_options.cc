...
ImmutableCFOptions::ImmutableCFOptions(const ColumnFamilyOptions& cf_options)
    : compaction_style(cf_options.compaction_style),
      ...
      max_gc_compactions(cf_options.max_gc_compactions),
      gc_multiple(cf_options.gc_multiple),
      gc_garbage_threshold(cf_options.gc_garbage_threshold),
      gc_range_tables_threshold(cf_options.gc_range_tables_threshold),
      pick_table_threshold(cf_options.pick_table_threshold),
      pick_table_max_multiple(cf_options.pick_table_max_multiple),
      enable_vertical_compaction(cf_options.enable_vertical_compaction),
      vc_merge_threshold(cf_options.vc_merge_threshold),
      vc_merge_threshold_nostart(cf_options.vc_merge_threshold_nostart),
      vertical_start_level(cf_options.vertical_start_level),
      vertical_min_involve_levels(cf_options.vertical_min_involve_levels),
      pick_index_min_table_numbers(cf_options.pick_index_min_table_numbers),
      choose_guard_interval(cf_options.choose_guard_interval),
      neighbor_guard_ratio(cf_options.neighbor_guard_ratio),
      enable_estimate_seek(cf_options.enable_estimate_seek),
      estimate_interval(cf_options.estimate_interval),
      estimate_threshold(cf_options.estimate_threshold),
      max_write_buffer_number_to_maintain(
      ...
      second_table_factory(cf_options.second_table_factory),
      table_properties_collector_factories(
