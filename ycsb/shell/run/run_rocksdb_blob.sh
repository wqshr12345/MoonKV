...
for workload in ${workloads[@]};do
    ...
    workload_param="workloads/rocksdb_blob/${workload}"
    log="result/rocksdb_blob/${workload}/output.txt"
    while true; do
        cmd="shell/exec/ycsb_rocksdb -load -run -db rocksdb -P ${workload_param} -P rocksdb/rocksdb_blob.properties -s >${log}"
