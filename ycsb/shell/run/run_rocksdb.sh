...
for workload in ${workloads[@]};do
    ...
    workload_param="workloads/rocksdb/${workload}"
    log="result/rocksdb/${workload}/output.txt"
    while true; do
        cmd="shell/exec/ycsb_rocksdb -load -run -db rocksdb -P ${workload_param} -P rocksdb/rocksdb.properties -s >${log}"
