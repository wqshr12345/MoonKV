...
class NvmTableFactory : public TableFactory {
 public:
  explicit NvmTableFactory(
  ...
  const char* Name() const override { return kNvmTableName(); }
  ...
  TailPrefetchStats2* tail_prefetch_stats() { return &tail_prefetch_stats_; }
